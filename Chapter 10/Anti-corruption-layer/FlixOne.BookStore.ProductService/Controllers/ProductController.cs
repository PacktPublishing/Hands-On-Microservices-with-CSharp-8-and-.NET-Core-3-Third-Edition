...
namespace FlixOne.BookStore.ProductService.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        [HttpGet]
        [Route("shipping/{productid}")]
        public IActionResult ShippingInfo(string productid)
        {
            var reportData = _productRepository.ToReportData(new Guid(productid));
            return new OkObjectResult(reportData);
        }
