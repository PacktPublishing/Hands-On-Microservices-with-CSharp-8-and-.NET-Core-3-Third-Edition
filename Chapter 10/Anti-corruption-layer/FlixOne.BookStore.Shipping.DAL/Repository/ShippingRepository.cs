...
namespace FlixOne.BookStore.Shipping.DAL.Repository
{
    public class ShippingRepository : IShippingRepository
    {
        ...
        public ShippingRepository(ShipmentDbContext context)
        {
            _context = context;
        }
        ...
        {
            return _context.Shippings.Where(s=>s.OrderId == orderId).FirstOrDefault();
        }
        ...
        {
            return _context.Addresses.Where(a => a.CustomerId == customerId).FirstOrDefault();
        }
        public Models.Shipping Get(Guid id)
        {
            return _context.Shippings.Where(c => c.Id == id).FirstOrDefault();
        }
